(() => {
  ...
  const battleDonAnimations = {
    joust: { src: "assets/battle/don/skill-1.gif", duration: 1020, hitTimes: [0.56], css: "skill1" },
    gallop: { src: "assets/battle/don/skill-2.gif", duration: 920, hitTimes: [0.58], css: "skill2" },
    justice: { src: "assets/battle/don/skill-3.gif", duration: 1780, hitTimes: [0.30, 0.58, 0.80], css: "skill3" },
  };
  ...
  function drawTargetLines(pointer = null) {
    ...
    battle.donSlots.forEach((slot) => {
      if (battle.dragSlot === null && slot.index !== battle.focusSlot) return;
