export const donBattleSkills = {
  joust: {
    ...
    effect:'[Clash Win] Gain 2 Haste next turn. [On Hit] Inflict 2 Rupture, +2 Count.',
    keywords:['Haste','Rupture','Clash Win'], expression:'lilAngry', animation:'lc-anim-joust',
    applyOnHit:[{ type:'rupture', potency:2, count:2 }],
  },
  gallop: {
...
export const keywordDescriptions = {
  ...
  Rupture:'Deals fixed damage based on Potency whenever the affected unit is hit. Count is consumed by hits.',
